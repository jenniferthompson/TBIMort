...
tbi.daily <- tbi.daily %>%
  mutate(any.prbc = factor(ifelse(units.prbc > 0, 2, 1),
         ...
         any.alpha2 = factor(as.numeric(any.dex == 'Some' | any.clonid == 'Some'),
...
daily.mort.org <- tbi.daily.icu %>%
  ...
  select(mrn, study.day, max.motor.imp, pupil.react.imp, min.glucose.imp, min.hemoglobin.imp,
         ...
         tot.dex.cube, tot.clonid.cube, any.prbc, any.plasmaplt)
...
#                                      rcs(tot.benzo.cube, 4) + tot.antipsyc.cube +
#                                      rcs(tot.betablock.cube, 4) + tot.propofol.cube +
#                                      tot.dex.cube + tot.clonid.cube +
