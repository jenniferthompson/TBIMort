...
areg.mort.inhosp <- aregImpute(~ age + gender + insurance.code + iss + cpr.yn + pt.marshall +
                                 ...
                                 mental.status + sofa.mod.nanormal.imp + max.icp.imp +
                                 tot.opioid.cube + tot.benzo.cube + tot.antipsyc.cube +
                                 tot.betablock.cube + tot.propofol.cube + tot.dex.cube +
                                 I(tot.pento.cube) + tot.clonid.cube + units.prbc +
                                 units.plasma + units.platelets + units.cryo + start.day,
...
mod.mort.inhosp <- fit.mult.impute(Surv.mort.inhosp ~ rcs(age, 4) + gender + insurance.code +
                                     ...
                                     I(max.motor.imp) + pupil.react.imp + rcs(min.glucose.imp, 4) +
                                     rcs(min.hemoglobin.imp, 4) + rcs(min.sodium.imp, 4) +
                                     mental.status + rcs(sofa.mod.nanormal.imp, 4) +
                                     rcs(max.icp.imp, 4) + rcs(tot.opioid.cube, 4) +
                                     rcs(tot.benzo.cube, 4) + rcs(tot.antipsyc.cube, 4) +
                                     rcs(tot.betablock.cube, 4) + rcs(tot.propofol.cube, 4) +
                                     rcs(tot.dex.cube, 4) + I(tot.pento.cube) +
                                     rcs(tot.clonid.cube, 4) + rcs(units.prbc, 3) +
                                     rcs(units.plasma, 3) + rcs(units.platelets, 3) +
                                     rcs(units.cryo, 3),
                                   fitter = cph,
