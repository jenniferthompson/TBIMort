...
All `r format(length(pts.inc.survived), big.mark = ',')` patients in the main cohort will be
included in our model for delirium duration; `r n.deldays.missany` of these (`r round((n.deldays.missany / length(pts.inc.survived))*100)`%) are missing one or more baseline covariates and/or delirium duration. `r table_nums("deldays_missing", display = 'cite')` details how many patients in our cohort are missing which covariates or outcome. This missingness will be
