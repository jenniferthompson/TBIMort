...
create_deldays_figures <- function(df){
  ...
  p +
    ...
    theme_minimal() +
    theme(panel.border = element_rect(fill = NA, colour = "grey92"))
}

deldays.plots <- map(deldays.predvals, create_deldays_figures)
multiplot(deldays.plots, layout = matrix(1:length(deldays.plots), ncol = 1))
