...
complete.delsummary.daily <- complete(mice.delsummary.daily, action = 'long', include = TRUE)
...
complete.delsummary.base <- complete(mice.delsummary.base, action = 'long', include = TRUE)
