...
label(tbi.daily$sofa.nanormal.imp) <- 'Overall SOFA (imputed components), missing considered normal'
label(tbi.daily$sofa.namissing.imp) <- 'Overall SOFA (imputed components), missing left as missing'
...
label(tbi.daily$sofa.mod.nanormal.imp) <-
  'Modified SOFA (imputed components), missing considered normal'
label(tbi.daily$sofa.mod.namissing.imp) <-
  'Modified SOFA (imputed components), missing left as missing'
